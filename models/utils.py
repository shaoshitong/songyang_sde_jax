...
def get_model_fn(model, params, states, train=False, is_teacher=False):
...
def get_score_fn(sde, model, params, states, train=False, continuous=False, return_state=False, is_teacher=False):
    ...
    model_fn = get_model_fn(model, params, states, train=train, is_teacher=is_teacher)
